...
{
    public EmployeeDeletedEvent(int id, string name, string email, string phoneNumber, DateTime hireDate, int jobId, decimal salary, int? managerId, DepartamentEntity department)
